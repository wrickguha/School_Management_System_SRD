...
export const LandingLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 transition-colors">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-24 md:h-28 flex items-center justify-between relative py-2">
          <Link to="/" className="flex items-center gap-3 group">
            <img src={logoUrl} alt="SubhraEdu Logo" className="h-20 md:h-24 w-auto object-contain group-hover:scale-[1.03] transition-transform duration-300 drop-shadow-sm" />
          </Link>
      ...
      <footer className="bg-slate-900 text-slate-300 border-t border-slate-800 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="space-y-4">
            <div className="flex items-center gap-3 bg-white p-3 rounded-2xl shadow-premium border border-slate-100 hover:scale-[1.03] transition-all duration-300 inline-block max-w-max">
              <img src={logoUrl} alt="SubhraEdu Logo" className="h-16 md:h-20 w-auto object-contain" />
            </div>
